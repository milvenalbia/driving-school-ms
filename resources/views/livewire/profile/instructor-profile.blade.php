                ...
                <div class="pt-8">
                    ...
                    <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3">
                            <label for="driving_experience" class="block text-sm font-medium text-gray-700">Phone Number</label>
                            <div class="mt-1" x-data="{ driving_experience: @entangle('driving_experience')}">
                                <x-elements.text-input x-model="driving_experience" wire:model="driving_experience" class="!py-2 border-boxdark" id="driving_experience" type="text" name="driving_experience" @input="driving_experience = driving_experience.replace(/[^0-9]/g, '')"
                                @keydown="if (driving_experience.length >= minLength && event.keyCode !== 8 && event.keyCode !== 46) event.preventDefault()" />
                            </div>
                            @error('driving_experience') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <x-elements.text-input type="text" wire:model="address" id="address" class="!py-2 border-boxdark" />
                            </div>
                        </div>
